...
//dotnet run add new package Newtonsoft.Json
class Program
{
...
//metodo per andare a modificare il prodotto esistente
public void AggiornaProdotto(int id, ProdottoAdvanced nuovoProdotto)
{
    ...
    // inizializzo la lista di prodotti nel costruttore pubblico in modo che sia accessibile dall'esterno
}
