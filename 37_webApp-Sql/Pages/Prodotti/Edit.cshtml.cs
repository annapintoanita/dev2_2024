    ...
    public IActionResult OnPost()
    {
        ...
        try
        {
            DbUtils.ExecuteNonQuery(
                @"UPDATE Prodotti SET Nome = @nome, Prezzo = @prezzo, CategoriaId = @categoriaId, FornitoreId = @idFornitore 
                WHERE Id = @id",
                cmd =>
                {
                    ...
                    cmd.Parameters.AddWithValue("@idFornitore", Prodotto.IdFornitore);
